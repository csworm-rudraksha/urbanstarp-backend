...
exports.seedDatabase = exports.sampleUsers = exports.sampleProducts = void 0;
...
const seedDatabase = async () => {
    try {
        ...
        await Product_1.default.insertMany(exports.sampleProducts);
        // Insert sample users
        ...
        console.log(`Created ${exports.sampleProducts.length} products`);
        console.log(`Created ${exports.sampleUsers.length} users`);
    }
    catch (error) {
